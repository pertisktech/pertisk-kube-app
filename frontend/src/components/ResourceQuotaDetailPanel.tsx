  ...
  return (
    <ResizablePanel>
      <div className="h-full flex flex-col">
        <DetailPanelHeader title="ResourceQuota Info" onClose={onClose}>
          <div className="flex gap-2">
            <div className="group relative">
              <button type="button" onClick={() => onOpenYamlEditor?.(resourceQuota)} className="p-2 rounded-md border border-[var(--color-primary)] text-[var(--color-primary)] hover:bg-[var(--color-primary)]/10 transition-colors" aria-label="Edit resourcequota YAML"><Pencil size={12} /></button>
            ...
            <div className="group relative">
              <button type="button" onClick={() => onDelete?.(resourceQuota.namespace, resourceQuota.name)} className="p-2 rounded-md border border-[var(--color-icon-danger)] text-[var(--color-icon-danger)] hover:bg-[var(--color-icon-danger)]/10 transition-colors" aria-label="Delete resourcequota"><Trash2 size={12} /></button>
